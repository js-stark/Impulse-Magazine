        ...
        <div class="wrapper">
            ...
            <div class="details">
                <div class="content">
                    ...
                    <p>What an immense pleasure it is to get back to you again! Delivering articles to you is the one lovely thing which has always inspired and will definitely inspire our squad to work more for the impulse. For the last time our team is again all set to present the 38th edition of Impulse. Our writers have done all possible browsing and surfing to enlighten you with their most amusing and most informative write-ups. Dr.Ganesh Kumar Srinivasan is the most renowned and jovial professor we have ever seen. Dont miss out his interview. K.keerthika from first year has written on Avian Protection Power Plan and you can have a read on Buck Boost Transformer and also the Kurukshetra Innovative Projects. And there are many to explore in this Magazine.Don't forget to turn to our last page and have a look at the memes in the Memes corner</p>
                    <h3>30 min</h3>
                    <a href="./read2020ed3.php"><button>Read Now</button></a>
                </div>
            </div>
        </div>
        <div class="t20ed3 magazine">
          <div class="book">
            <img src="../images/magazine/IM2020ed3/cover/1.jpg">
          </div>
        </div>
    </div>

    ...
    <div id="book" class="book">
        ...
        <div id="p1" class="paper">
            <div class="front">
                <div id="f1" class="front-content">
                    <img src="../images/magazine/IM2020ed2/1.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b1" class="back-content">
                <img src="../images/magazine/IM2020ed2/2.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 2 -->
        <div id="p2" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2020ed2/3.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b2" class="back-content">
                <img src="../images/magazine/IM2020ed2/4.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 3 -->
        <div id="p3" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2020ed2/5.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b3" class="back-content">
                <img src="../images/magazine/IM2020ed2/6.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 4 -->
        <div id="p4" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2020ed2/7.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b4" class="back-content">
                <img src="../images/magazine/IM2020ed2/8.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 5 -->
        <div id="p5" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2020ed2/9.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b5" class="back-content">
                <img src="../images/magazine/IM2020ed2/10.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 6 -->
        <div id="p6" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2020ed2/11.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b6" class="back-content">
                <img src="../images/magazine/IM2020ed2/12.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 7 -->
        <div id="p7" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2020ed2/13.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b7" class="back-content">
                <img src="../images/magazine/IM2020ed2/14.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 8 -->
        <div id="p8" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2020ed2/15.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b8" class="back-content">
                <img src="../images/magazine/IM2020ed2/16.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 9 -->
        <div id="p9" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2020ed2/17.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b9" class="back-content">
                <img src="../images/magazine/IM2020ed2/18.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 10 -->
        <div id="p10" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2020ed2/19.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b10" class="back-content">
                <img src="../images/magazine/IM2020ed2/20.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
...
<!---------------------------------------XXXXXXXXX ---------------------------------------------------- -->
   ...
   <!-- Magazine js -->
   <script src="./readMag2020ed2.js"></script>
   <script>

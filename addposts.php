...
<?php
  if(isset($_POST['Submit'])){
    ...
    elseif (strlen($PostText)>9999){
      ...
      // Query to insert the Post data into the Impulse Database
      ...
      if($Execute){
        ...
        $_SESSION["SuccessMessage"] = "Post with id '".$conn->lastInsertId()."' Added Succesfully";
        Redirect_to("addposts.php");
      }
      else{
...
<body>
  ...
  <header class="bg-dark text-white py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1><i class="fas fa-edit" style="color:#27aae1;"></i>Add Blog Posts</h1>
        </div>
      </div>
    </div>
  </header>
            ...
            <form action="addposts.php" method="post" enctype="multipart/form-data">
                <div class="card bg-secondary text-light mb-3">
                    ...
                    <div class="card-body bg-dark">      <!--form body-->
                        <div class="form-group mb-2"> <!--form input group-->
                        ...
                        <div class="form-group"> <!--form input group-->
                            <label  for="author"><span class="FieldInfo"> Legacy Authors </span></label>
                            <!-- Input Field for the Category Section with name Title -->
                            <input class="form-control" type="text" name="legacy" id="author" placeholder="Legacy Authors Name">
                            <small class="text-danger">*Optional only if this is written by a Legacy Author of Impulse mention Their name here</small>
                        </div>

    ...
    <div id="book" class="book">
        ...
        <div id="p1" class="paper">
            <div class="front">
                <div id="f1" class="front-content">
                    <img class="img-fluid" src="../images/magazine/IM2021ed1/1.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b1" class="back-content">
                <img src="../images/magazine/IM2021ed1/2.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 2 -->
        <div id="p2" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/3.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b2" class="back-content">
                <img src="../images/magazine/IM2021ed1/4.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 3 -->
        <div id="p3" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/5.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b3" class="back-content">
                <img src="../images/magazine/IM2021ed1/6.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 4 -->
        <div id="p4" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/7.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b4" class="back-content">
                <img src="../images/magazine/IM2021ed1/8.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 5 -->
        <div id="p5" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/9.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b5" class="back-content">
                <img src="../images/magazine/IM2021ed1/10.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 6 -->
        <div id="p6" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/11.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b6" class="back-content">
                <img src="../images/magazine/IM2021ed1/12.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 7 -->
        <div id="p7" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/13.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b7" class="back-content">
                <img src="../images/magazine/IM2021ed1/14.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 8 -->
        <div id="p8" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/15.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b8" class="back-content">
                <img src="../images/magazine/IM2021ed1/16.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 9 -->
        <div id="p9" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/17.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b9" class="back-content">
                <img src="../images/magazine/IM2021ed1/18.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 10 -->
        <div id="p10" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/19.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b10" class="back-content">
                <img src="../images/magazine/IM2021ed1/20.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 11 -->
        <div id="p11" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/21.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b11" class="back-content">
                <img src="../images/magazine/IM2021ed1/22.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Paper 12 -->
        <div id="p12" class="paper">
            <div class="front">
                ...
                <img src="../images/magazine/IM2021ed1/23.jpg" alt="">
                </div>
            </div>
            <div class="back">
                <div id="b12" class="back-content">
                <img src="../images/magazine/IM2021ed1/24.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
...
<!---------------------------------------XXXXXXXXX ---------------------------------------------------- -->
   ...
   <!-- Magazine js -->
   <script src="./readMag2021ed1.js"></script>
   <script>
